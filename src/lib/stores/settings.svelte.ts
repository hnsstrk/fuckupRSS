...
class SettingsStore {
  ...
  async init() {
    ...
    try {
      ...
      this.#settings.show_terminology_tooltips =
        (dbSettings.showTerminologyTooltips as boolean) ?? true;
      ...
      this.#settings.enable_headless_browser =
        (dbSettings.enable_headless_browser as boolean) ?? false;
