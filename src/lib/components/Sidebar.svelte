<script lang="ts">
  ...
  let { onsettings, onnetwork, onfnord, onhome, networkActive = false, fnordActive = false }: Props = $props();
  ...
  <div class="sidebar-header">
    <div class="header-row">
      ...
      <div class="header-actions">
        {#if onhome && (networkActive || fnordActive)}
          <button onclick={onhome} class="icon-btn" title={$_('actions.home')} aria-label={$_('actions.home')}>
