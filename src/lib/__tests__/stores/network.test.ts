...
describe("Network Store / Immanentize Network", () => {
  ...
  describe("Error handling", () => {
    it("should handle network errors for get_keywords", async () => {
      ...
      await expect(invoke("get_keywords", { limit: 50, offset: 0 })).rejects.toThrow(
    ...
    it("should handle network errors for get_keyword_neighbors", async () => {
      ...
      await expect(invoke("get_keyword_neighbors", { id: 99999, limit: 20 })).rejects.toThrow(
        "Keyword not found",
      );
    });
    ...
    it("should handle network errors for get_network_graph", async () => {
      ...
      await expect(invoke("get_network_graph", { limit: 100, minWeight: 0.1 })).rejects.toThrow(
