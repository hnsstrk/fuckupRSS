...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::retrieval::refetch_feed_short_articles,
            ...
            // Model Management
            commands::ai::model_management::check_ollama,
            commands::ai::model_management::get_loaded_models,
            commands::ai::model_management::load_model,
            ...
            commands::ai::article_processor::process_article,
            commands::ai::article_processor::process_article_discordian,
            // Batch Processing
            commands::ai::batch_processor::get_unprocessed_count,
            commands::ai::batch_processor::get_hopeless_count,
            commands::ai::batch_processor::get_failed_count,
            commands::ai::batch_processor::get_failed_articles,
            ...
            commands::ai::prompts::set_prompts,
            commands::ai::prompts::reset_prompts,
            commands::ai::prompts::reset_articles_for_reprocessing,
