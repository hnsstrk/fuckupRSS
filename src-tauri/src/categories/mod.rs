    ...
    fn parse_categories(&self, response: &str) -> Vec<String> {
        ...
        let categories: Vec<String> = cleaned
            ...
            .filter_map(|s| {
                ...
                if SEPHIROTH_CATEGORIES.contains(&normalized.as_str()) && seen.insert(normalized.clone()) {
                    Some(normalized)
                } else {
                    None
                }
...
pub fn classify_by_keywords(keywords: &[String]) -> Vec<String> {
    let keyword_category_map: &[(&[&str], &str)] = &[
        (&["software", "app", "ki", "ai", "computer", "internet", "digital", "algorithmus", "programmierung", "cloud", "server", "daten", "cyber", "online", "smartphone", "chip", "prozessor"], "Technik"),
        (&["regierung", "minister", "kanzler", "präsident", "partei", "wahl", "gesetz", "parlament", "bundestag", "koalition", "opposition", "abgeordnete", "politiker", "diplomat"], "Politik"),
        (&["unternehmen", "konzern", "aktie", "börse", "umsatz", "gewinn", "inflation", "zinsen", "bank", "investition", "export", "import", "handel", "arbeitsmarkt", "insolvenz"], "Wirtschaft"),
        (&["forscher", "studie", "wissenschaftler", "universität", "forschung", "entdeckung", "experiment", "labor", "nasa", "esa", "satellit", "mars", "mond"], "Wissenschaft"),
        (&["film", "musik", "kunst", "theater", "museum", "künstler", "konzert", "festival", "autor", "buch", "ausstellung", "kultur", "literatur", "kino"], "Kultur"),
        (&["fußball", "bundesliga", "champions", "olympia", "tennis", "formel", "rennen", "meister", "trainer", "spieler", "tor", "sieg", "niederlage", "turnier", "mannschaft"], "Sport"),
        (&["familie", "kinder", "schule", "bildung", "migration", "flüchtling", "integration", "rente", "sozial", "armut", "demografe", "wohnung", "miete"], "Gesellschaft"),
        (&["klima", "umwelt", "co2", "emission", "naturschutz", "artenschutz", "nachhaltigkeit", "wetter", "sturm", "überschwemmung", "dürre", "temperatur", "erderwärmung"], "Umwelt"),
        (&["polizei", "kriminalität", "verbrechen", "mord", "raub", "betrug", "terror", "anschlag", "festnahme", "ermittlung", "verdächtig", "hacker", "cyberangriff"], "Sicherheit"),
        (&["krankenhaus", "arzt", "patient", "krankheit", "impfung", "medikament", "therapie", "virus", "pandemie", "pflege", "krankenkasse", "operation", "diagnose"], "Gesundheit"),
        (&["bundeswehr", "soldat", "militär", "nato", "krieg", "konflikt", "waffe", "panzer", "rakete", "verteidigung", "armee", "truppen", "angriff", "invasion"], "Verteidigung"),
        (&["strom", "gas", "öl", "kohle", "atomkraft", "kernkraft", "windkraft", "solar", "photovoltaik", "energiewende", "blackout", "netz", "kraftwerk"], "Energie"),
        (&["gericht", "richter", "urteil", "klage", "anwalt", "prozess", "strafe", "verurteilung", "berufung", "datenschutz", "verfassungsgericht", "staatsanwalt"], "Recht"),
    ];

    let mut category_scores: std::collections::HashMap<&str, i32> = std::collections::HashMap::new();
