...
static CATEGORY_TERMS: LazyLock<HashMap<i64, (&'static str, Vec<WeightedTerm>)>> =
    LazyLock::new(|| {
        ...
        m.insert(
            ...
            (
                ...
                vec![
                    ...
                    wt("lernen", 0.8),
                    wt("blockchain", 1.4),
                    wt("kryptowährung", 1.3),
                    wt("bitcoin", 1.3),
                    wt("cybersecurity", 1.4),
                    wt("hacker", 1.2),
                    wt("virus", 1.0),
                    wt("startup", 1.1),
                    wt("innovation", 1.0),
        ...
        m.insert(
            ...
            (
                ...
                vec![
                    ...
                    wt("schule", 1.1),
                    wt("universität", 1.0),
                    wt("gleichstellung", 1.3),
                    wt("diskriminierung", 1.3),
                    wt("rassismus", 1.3),
                    wt("protest", 1.2),
                    wt("demonstration", 1.3),
                    wt("aktivist", 1.2),
                    wt("religion", 1.2),
                    wt("kirche", 1.1),
                    wt("islam", 1.2),
        ...
        m.insert(
            ...
            (
                ...
                vec![
                    ...
                    wt("energiewende", 1.5),
                    wt("kohle", 1.3),
                    wt("kohleausstieg", 1.4),
                    wt("photovoltaik", 1.4),
                    wt("wasserstoff", 1.4),
                    wt("batterie", 1.2),
                    wt("netzausbau", 1.3),
                    wt("strompreis", 1.3),
                    wt("energiekosten", 1.3),
                ],
            ),
        );
        ...
        m.insert(
            ...
            (
                ...
                vec![
                    ...
                    wt("naturschutz", 1.4),
                    wt("artenschutz", 1.4),
                    wt("biodiversität", 1.4),
                    wt("nachhaltigkeit", 1.3),
                    wt("nachhaltig", 1.2),
                    wt("ökologie", 1.3),
                    wt("emission", 1.4),
                    wt("treibhausgas", 1.4),
                    wt("kohlendioxid", 1.3),
                    wt("verschmutzung", 1.3),
                    wt("plastik", 1.2),
                    wt("müll", 1.1),
                    wt("recycling", 1.2),
                    wt("wald", 1.1),
